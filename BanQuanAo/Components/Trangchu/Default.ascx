<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Default.ascx.cs" Inherits="BanQuanAo.Component.trangchu.Default" %>
<%@ Register Src="~/Modules/Slideshow.ascx" TagPrefix="uc1" TagName="Slideshow" %>
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                        <div class="product">
                            ...
                            <div class="product-viewcart">
                                ...
                                <%--<a class="btn btn-info btn-mua" href="default.aspx?option=giohang&id=<%# Eval("Id") %>" role="button">
                                    <span class="glyphicon glyphicon-shopping-cart"></span>Mua ngay
                                </a>--%>
